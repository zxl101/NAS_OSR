...
class MNIST_Dataset(Dataset):
    ...
    def sampler_search(self, seed, args):
        ...
        osr_trainset, osr_valset, osr_pickset, osr_testset = construct_ocr_dataset_aug(self.trainset, self.testset,
                                                                      seen_classes, val_classes,
                                                                      unseen_classes, self.transform_train, self.transform_test, args)

        return osr_trainset, osr_valset, osr_pickset, osr_testset
...
class CIFAR10_Dataset(Dataset):
    ...
    def sampler_search(self, seed, args):
        ...
        unseen_classes = [idx for idx in unseen_classes if idx not in val_classes]
        # print(seen_classes)
        osr_trainset, osr_valset, osr_pickset, osr_testset = construct_ocr_dataset_aug(self.trainset, self.testset, seen_classes, val_classes,
                                                                      unseen_classes, self.transform_train, self.transform_test, args)
    ...
    def sampler_train(self, seed, args):
        ...
        seen_classes = seen_classes + val_classes
        # print(seen_classes)
        osr_trainset, osr_valset, osr_testset = construct_ocr_dataset_aug(self.trainset, self.testset, seen_classes, None,
                                                                      unseen_classes, self.transform_train, self.transform_test, args)
...
class CIFARAdd10_Dataset(Dataset):
    ...
    def sampler_search(self, seed, args):
        ...
        val_classes = [idx for idx in range(10) if idx not in seen_classes]
        val_classes = random.sample(val_classes, 2)
        # animal in CIFAR100
        ...
        osr_trainset, osr_valset, osr_pickset, osr_testset = construct_ocr_dataset_add(self.trainset, self.testset, self.unknownset, seen_classes,
                                                                                       val_classes,
                                                                      unseen_classes, self.transform_train, self.transform_test, args)
...
class CIFARAdd50_Dataset(Dataset):
    ...
    def sampler_search(self, seed, args):
        ...
        osr_trainset, osr_valset, osr_pickset, osr_testset = construct_ocr_dataset_add(self.trainset, self.testset, self.unknownset, seen_classes, val_classes,
                                                                      unseen_classes, self.transform_train, self.transform_test, args)
    ...
    def sampler_train(self, seed, args):
        ...
        osr_trainset, osr_valset, osr_testset = construct_ocr_dataset_add(self.trainset, self.testset, self.unknownset, seen_classes, None,
                                                                      unseen_classes, self.transform_train, self.transform_test, args)
...
class SVHN_Dataset(Dataset):
    ...
    def sampler_search(self, seed, args):
        ...
        osr_trainset, osr_valset, osr_pickset, osr_testset = construct_ocr_dataset_aug(self.trainset, self.testset,
                                                                      seen_classes, val_classes, unseen_classes,
...
def construct_ocr_dataset_aug(trainset, testset, seen_classes, val_classes, unseen_classes, transform_train, transform_test, args):
    if args.dataset in ['MNIST', 'CIFAR10', 'CIFAR100']:
        ...
        if val_classes != None:
            osr_pickset = DatasetBuilder(
                [get_class_i(testset.data, testset.labels, idx) for idx in val_classes],
                transform_test)
...
def construct_ocr_dataset_add(trainset, testset, unknownset, seen_classes, val_classes, unseen_classes, transform_train, transform_test, args):
    ...
    if val_classes != None:
        osr_pickset = DatasetBuilder(
            [get_class_i(unknownset.data, unknownset.targets, idx) for idx in val_classes],
            transform_test)
